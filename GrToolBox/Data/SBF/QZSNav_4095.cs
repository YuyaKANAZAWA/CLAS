...
{
    public class QZSNav_4095 : Header_TimeStamp, IRawData
    {
        ...
        public QZSNav_4095(byte[] byteData, Header_TimeStamp h)
        {
            Decode(byteData, h);
        }
        ...
        private QzsNavData Sbf2Nav()
        {
            ...
            else if (IODC >= 240 && IODC <= 247) nav.FitInterval = 8;
            else if (IODC >= 248 && IODC <= 255 || IODC == 496) nav.FitInterval = 14;
            else if (IODC >= 497 && IODC <= 503 || IODC >= 1021 && IODC <= 1023) nav.FitInterval = 26;
            else if (IODC >= 504 && IODC <= 510) nav.FitInterval = 50;
            else if (IODC >= 752 && IODC <= 756 || IODC == 511) nav.FitInterval = 74;
            else if (IODC == 757) nav.FitInterval = 98;
